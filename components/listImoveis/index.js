...
import { urlImgs, moneyFormatter, titleSite, itensPorPagina, handleUrl, descriptionDefault,loaderImage,cloudflareLoader, urlSite,  urlFavicon, apiId, apiUrl } from '../../utils';
...
export default function ListImoveis(props) {    
    ...
    useEffect(() => {
        getImoveis()
        if(queryInicial.finalidade) mudarDadosFormulario({finalidade : queryInicial.finalidade == 2 ? 'Venda' : 'Aluguel'})

    },[])

    const getImoveis = async () => {
        const {query} = router
        if(query.finalidade) query.finalidade = query.finalidade == "Venda" ? 1:2;
                                    ...
                                    <div key={imovel.id} className="col-12 col-md-6 col-xl-3 py-4">
                                        <div onClick={() => onClick("imovel", imovel.id)} className="d-flex flex-column shadow h-100 item-grid">
                                            ...
                                            <div className="foto position-relative">
                                                ...
                                                ) : <Image src={'../../img/sm-foto.jpg'} loader={loaderImage} alt={imovel.tipo}  width="290" height="100"/> }      
                                            ...
                                            <div className="d-flex flex-grow-1 flex-column px-3 py-3">
                                                ...
                                                <div className="endereco font-12 line-height-130">
                                                    <Image src={'../../img/place.svg'} loader={loaderImage} alt="" width="290" height="100"/>
