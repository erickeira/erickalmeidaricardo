...
import { apiId, apiUrl, urlImgs, urlSite, urlFavicon, moneyFormatter,titleSite,cloudflareLoader,loaderImage } from '../../utils';
                ...
                <header className="d-flex topo-visualizacao justify-content-between align-items-center pt-5">
                    ...
                    <div className="row py-5">
                        <div className="col-12 col-lg-7">
                            ...
                            <div className="redes-sociais d-flex d-lg-none" >
                            ...
                            
                            {
                                (
                                    images ?
                                        ...
                                        : <ImageGallery lazyLoad={true} showFullscreenButton={true} items={images} loader={cloudflareLoader}  useBrowserFullscreen={ false } />
                                    
                                    : <div><Image src={'../../img/sm-foto.jpg'} loader={loaderImage}  width="300" height="300" /></div>
                                )
                            }
                            ...
                            <div className="d-block d-lg-none">
                                ...
                                <div className="d-block  border-top border-bottom py-3 flex-column flex-md-row">
                                    <div className="endereco d-flex align-items-center flex-grow-1 pr-4 font-14 line-height-130">
                                        <Image src={'../../img/place.svg'} loader={loaderImage}  alt="" width="150" height="150"/>
                        ...
                        <div className="col-12 col-lg-5">
                            ...
                            <div className="d-none d-lg-block">
                                ...
                                <div className="d-block border-top border-bottom py-3">
                                    <div className="endereco d-flex align-items-center flex-grow-1 pr-4 font-14 line-height-130">
                                        <Image src={'../../img/place.svg'} loader={loaderImage}  alt="" width="100" height="100"/>
                                        {`${dadosimovel.endereco ? `${dadosimovel.endereco} - ` : '' }${dadosimovel.bairro} | ${dadosimovel.cidade}/${dadosimovel.uf}`}
                                    </div>
